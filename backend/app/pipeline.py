...
def run_pipeline(document: str, *, template: Optional[dict] = None, opts: Optional[dict] = None) -> dict:
    ...
    # 10. optional badge staleness check (needs no repo access; ground truth is optional)
    badges_report = None
    ...
    # 11/12. optional doc-drift + version-sync — only meaningful with repo context
